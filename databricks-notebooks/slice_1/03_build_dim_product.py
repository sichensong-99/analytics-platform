...
# MAGIC
# MAGIC **Input**: `/Volumes/analytics_catalog/the-retailer/raw_uploads/ers/` (shared raw zone)
# MAGIC **Output**: `analytics_catalog.analytics_platform.dim_product`
...
# ERS CSV lives in the SHARED raw zone (the-retailer schema), not our project schema —
# ERS is company-wide product master, consumed by multiple projects.
ERS_VOLUME_PATH = f"/Volumes/{TARGET_CATALOG}/the-retailer/raw_uploads/ers/"
...
# MAGIC | Metric | Value |
# MAGIC |---|---|
# MAGIC | Target table | `analytics_catalog.analytics_platform.dim_product` |
# MAGIC | Source | ERS CSV @ `the-retailer/raw_uploads/ers/` (shared raw zone) |
