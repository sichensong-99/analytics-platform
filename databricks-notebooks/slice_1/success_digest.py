...
dbutils.widgets.text("fact_fqn", "mvdevdatabricks.analytics_platform_32degrees.fact_orders_line")
dbutils.widgets.text("history_fqn", "mvdevdatabricks.analytics_platform_32degrees.pipeline_run_history")
