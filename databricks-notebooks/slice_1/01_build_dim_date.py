...
# MAGIC `analytics_platform` has no Volume. Since `dim_date` is
...
# MAGIC
# MAGIC **Output**: `analytics_catalog.analytics_platform.dim_date`
# MAGIC
...
# MAGIC | Metric | Value |
# MAGIC |---|---|
# MAGIC | Target table | `analytics_catalog.analytics_platform.dim_date` |
