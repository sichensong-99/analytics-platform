...
> **Schema**: `analytics_catalog.analytics_platform` (`amazon_` prefix isolation)
...
表面看新平台"缺 98.5% 历史"。但核实业务用途后:**planning 团队用此数据跟进近期活跃
...
> 这个结论体现的是"知道什么能验证、什么不能,不在无效对比上硬凑结论,并能讲清原因"——
> 工程判断力的体现。
