...
> **Author**: Sia
> **Created**: 2026-05-27
> **Driving need**: stakeholder wants Amazon shipment data (currently in legacy
...
| Endpoint | `/fba/inventory/v1/summaries` and `/fba/inbound/v0/shipments` (TBD per stakeholder's data definition) |
...
│  • Whatever stakeholder wants displayed
▼
...
- stakeholder's SLA = weekly Monday. No business reason to do more.
...
- Metrics-service exposure (deferred until stakeholder needs frontend display)
- Frontend page (same)
