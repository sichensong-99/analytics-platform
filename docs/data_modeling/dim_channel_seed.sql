...
-- Target:      mvdevdatabricks.analytics_platform_32degrees.dim_channel
-- Author:      Sia Song
-- Created:     2026-05-18
-- Version:     1.0 (Slice 1)
-- ============================================================================
...
--      - Rationale: Executive (Leader) is accustomed to the legacy PBI
...
-- Distribution by legacy_channel_group (Leader-facing taxonomy)
