...
|---|---|---|
| `mvdevdatabricks.analytics_platform_32degrees.dim_date` | one row per calendar day | ISO year/week/day |
...
catalog `mvdev_federated_catalog.triple_whale`) for attribution; ERS product
