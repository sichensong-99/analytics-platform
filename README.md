...
> 📝 Deep-dive: [Trust, but verify — why I refused to just match the legacy numbers](docs/blog/reconciliation-as-falsification.md)

# Internal Analytics Platform

> End-to-end data platform replacing Power BI Service for the the retailer ecom
