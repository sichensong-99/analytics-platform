      ...
      <main className="max-w-4xl mx-auto px-6 py-8 space-y-8">
        <header>
          ...
          <p className="text-gray-600 mt-2">
            This is the the retailer internal analytics portal. It replaces the legacy
        ...
        <section className="space-y-4">
          ...
          <Workflow
            ...
            steps={[
              ...
              'Click Download CSV (style-level) for one row per style × channel × week, or Download CSV (SKU-level) for the finer SKU (variant) grain with a dollar-sales column. Both export every matching row, not just the page you are viewing.',
            ]}
          />
        ...
        <section className="bg-white p-5 rounded-lg border border-amber-200">
          ...
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1.5">
            <li><span className="font-medium">Coverage:</span> sales data and channel attribution are both available from <span className="font-medium">July 2025</span>.</li>
            <li><span className="font-medium">Channel attribution</span> comes from Triple Whale, adopted on 2025-07-01. Cross-source order match is 99.9%+ from July 2025, so channel splits are usable across the report&rsquo;s full window. Periods before July 2025 fall back to GA4-derived channel grouping; the platform carries both taxonomies so historical and current channel views stay continuous.</li>
            ...
            <li><span className="font-medium">Replacement-order exclusion:</span> the replacement-order metafield has an upstream sync gap for <span className="font-medium">Jan–Apr 2026</span>, so a small number of replacement orders in those months are not yet excluded (an upstream backfill is pending). All other periods are excluded as expected.</li>
            <li><span className="font-medium">Amazon</span> data is a weekly snapshot from Amazon&rsquo;s SP-API.</li>
            <li><span className="font-medium">Reconciliation:</span> Style × Channel quantities reconcile to within <span className="font-medium">~1.7%</span> of the legacy Panoply report (last validated baseline; Panoply has since been retired).</li>
          </ul>
        </section>
        ...
        <section className="bg-white p-5 rounded-lg border border-gray-200">
          ...
          <div className="space-y-3 text-sm">
            <Faq q="Why don&rsquo;t the numbers exactly match the old Panoply report?"
                 a="They reconcile to within ~1.7%. The platform nets refunds at the line-item level and excludes replacement / EXC orders — a data-quality improvement over the legacy logic. See the Metrics Catalog for each metric&rsquo;s exact rules." />
        ...
        <p className="text-xs text-gray-400">
          This guide ships and versions with the product. If something here doesn&rsquo;t match what you
